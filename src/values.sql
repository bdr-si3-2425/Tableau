...
(5,7,'2025-02-06','2025-02-20',0),
(3,4,'2025-02-05','2025-02-28',1),
(4,4,'2025-03-05','2025-03-28',0),
(6,4,'2025-04-05','2025-03-29',0),
(7,4,'2025-06-09','2025-07-28',0),
(2,4,'2025-08-05','2025-08-13',0),
(1,4,'2025-08-15','2025-09-01',0),
(6,6,'2025-02-05','2025-02-28',0),
(2,3,'2025-02-05','2025-02-28',0),
(7,2,'2025-02-05','2025-02-28',0),
(6,2,'2025-02-05',NULL,0),
(4,2,'2025-02-06',NULL,0);
...
INSERT INTO Personnel (id, nom, prenom, email, telephone, adresse, role, bibliotheque_id) VALUES
(1,'Leroy', 'Camille', 'camille.leroy@mail.com', '0678901234', '3 rue du Savoir, Paris', 'gestionnaire', 1),
(2,'Dubois', 'Luc', 'luc.dubois@mail.com', '0689012345', '8 place du Marché, Lyon', 'bibliothécaire', 2),
(3,'Morel', 'Nina', 'nina.morel@mail.com', '0690123456', '12 boulevard Victor, Toulouse', 'administrateur', 3),
(4,'Faure', 'Pierre', 'pierre.faure@mail.com', '0676543210', '25 rue du Lac, Marseille', 'bibliothécaire', 4),
(5,'Bertrand', 'Julie', 'julie.bertrand@mail.com', '0665432109', '7 avenue du Nord, Lille', 'gestionnaire', 5);
